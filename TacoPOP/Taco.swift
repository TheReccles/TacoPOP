...
//perfect place to use structure instead of class, bc we will have a bunch of tacos and none need to have references. when we pass them around they need to be passed around as copies.
